...
while programa:
    ...
    while ranking:
        ...
        kevin = small_font2.render('Kevin Yao Ji', 0, (255, 255, 255))
        ...
        tia_kevin = small_font2.render('4191649-2', 0, (255, 255, 255))
        ...
        tia_pedro_pos = tia_pedro.get_rect(center = (428, 380))
        tia_lucas_pos = tia_lucas.get_rect(center = (428, 405))
        tia_claudio_pos = tia_claudio.get_rect(center = (428, 430))
        tia_kevin_pos = tia_claudio.get_rect(center = (428, 455))
        ...
        screen.blit(tia_kevin, tia_kevin_pos)
